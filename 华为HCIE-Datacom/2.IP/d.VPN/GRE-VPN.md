...
![](assets/GRE-VPN/file-20251207204746654%201.png)
...
- 运输协议是指被封装以后的报文在新网络中传输时所使用的网络协议。
 ![](assets/IPSec-VPN/file-20251207204746486%201.png)

==GRE的主要缺点是不支持加密和认证，数据的安全传输得不到很好的保障。  ==
==IPSec的主要缺点是只支持IP协议，且不支持组播。  ==
==**可通过部署GRE Over IPSec结合两种VPN技术的优点。**==
![](assets/GRE-VPN/file-20251207204746654.png)

![](assets/GRE-VPN/file-20251207204746653%201.png)
```R
...
```
![](assets/GRE-VPN/file-20251207204746653.png)
