...
![](assets/3、工作原理/file-20251212164630713.png)
### **VXLAN MAC地址表项**  
...
![](assets/3、工作原理/file-20251212164630712%201.png)   
**如何将数据帧转发至连接在远端VTEP下的设备呢？**
MAC地址动态学习  
转发属于远端VTEP下所连接设备的数据帧，需要先学习到远端设备的MAC地址。  
该过程与传统MAC地址表形成过程类似，依赖于主机之间的报文交互，一般通过ARP报文交互形成MAC地址表项。
![](assets/3、工作原理/file-20251212164630710%201.png)
![](assets/3、工作原理/file-20251212164630712.png)  

**同子网已知目的地址单播报文转发**
![](assets/3、工作原理/file-20251212164630711.png)  

**BUM流量转发**  
传输BUM（Broadcast、Unknown、Multicast）流量时，  
VTEP会将流量复制多份发送到头端复制列表中的对端VTEP，从而在Overlay网络中实现泛洪转发的效果。
![](assets/3、工作原理/file-20251212164630710.png)  

**跨子网转发**
![](assets/3、工作原理/file-20251212164630709.png)