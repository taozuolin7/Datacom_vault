...
ospfv3的RID必须手工配置,RID值依然是32位无符号的整数  
## **ospfv3的配置：**  
[AR1]ospfv3 1  
[AR1-ospfv3-1]router-id 10.1.1.1
 
[AR1]interface GigabitEthernet0/0/0  
[AR1-interface-GigabitEthernet0/0/0  ]ospfv3 1 area 0.0.0.0  
**==ospfv3的地址通告只能在接口下使能ospfv3==**

## **ospfv3的特点：**  
1.链路本地地址的使用  
	1.ospfv3发送的报文SIP是每台设备的链路本地地址  
		ospfv3发送的报文DIP是固定的==ff02::5/6==  
	2.作为路由计算后的下一跳  
...
## OSPFv3的报文信息：  
#### **1.报文头部**
![800](assets/7、OSPFv3/file-20251208193729528.png)
#### 2.报文内容  
**1.hello报文**
![700](assets/7、OSPFv3/file-20251208193741139.png)
...
## OSPFv3的LSA的信息：  
### 1.LSA的头部
![](assets/7、OSPFv3/file-20251208194132357.png)
...
![600](assets/7、OSPFv3/file-20251208194334772.png)
### 2.LSA的内容  
1类LSA：作用类似，但是只描述拓扑信息，不描述路由信息
![700](assets/7、OSPFv3/file-20251208194458977.png)
2类LSA：作用类似，但是只描述拓扑信息，不描述路由信息
![800](assets/7、OSPFv3/file-20251208194511780.png)

==**1类、2类LSA不包含路由信息，所以完成了拓扑路由分离的操作，即路由的变化不会影响拓扑的重新计算==**
 
**3类LSA：作用类似，名称改变为inter-area-prefix-lsa（区域间前缀LSA）**
![800](assets/7、OSPFv3/file-20251208194526264.png)  

**4类LSA：作用类似，名称改变为inter-area-router-lsa（区域间路由器LSA）**
![800](assets/7、OSPFv3/file-20251208194737903.png)
   
**5.5类LSA：作用类似，功能相同**
![800](assets/7、OSPFv3/file-20251208194745571.png)
