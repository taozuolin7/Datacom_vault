...
**6to4的要求：**  
1.规划的站点IPv6网络前缀必须是固定的2002开头 16bit  
2.在固定的前缀后加入本端隧道的SIPv4地址 32bit  
3.后续的16bit作为子网前缀，区分不同的站点网段 16bit
   

**搞懂地址如何将****IPv4****地址嵌套再****IPv6****地址当中：**￼IPv4 2.2.2.2 # 1个地址块标识8bit二进制￼IPv6 2002:: /64 # 1个地址块标识4*4bit二进制  
1字节ipv4地址正好等于1块IPv6地址：2---\> 0000 0010 = 02  
￼IPv6 2002:2.2.2.2::2 ￼IPv6 2002:0202:0202::2

![Exported image](Exported%20image%2020251206150231-0.png)
...
![Exported image](Exported%20image%2020251206150232-1.png)

**IPv6过渡技术-动态6to4中继隧道：**￼本质：通过静态路由的递归从而找到路径