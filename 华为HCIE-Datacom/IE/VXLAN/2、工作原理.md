...
![Exported image](Exported%20image%2020251206151935-0.png)   
**VXLAN MAC地址表项**  
...
![Exported image](Exported%20image%2020251206151937-1.png)   
**如何将数据帧转发至连接在远端VTEP下的设备呢？**

![Exported image](Exported%20image%2020251206151938-2.png)

MAC地址动态学习  
转发属于远端VTEP下所连接设备的数据帧，需要先学习到远端设备的MAC地址。  
该过程与传统MAC地址表形成过程类似，依赖于主机之间的报文交互，一般通过ARP报文交互形成MAC地址表项。

![Exported image](Exported%20image%2020251206151940-3.png)  
![Exported image](Exported%20image%2020251206151942-4.png)  

**同子网已知目的地址单播报文转发**

![Exported image](Exported%20image%2020251206151947-5.png)  

**BUM流量转发**  
传输BUM（Broadcast、Unknown、Multicast）流量时，  
VTEP会将流量复制多份发送到头端复制列表中的对端VTEP，从而在Overlay网络中实现泛洪转发的效果。

![Exported image](Exported%20image%2020251206151949-6.png)  

**跨子网转发**

![Exported image](Exported%20image%2020251206151952-7.png)