...
![Exported image](Exported%20image%2020251206151650-0.png)
...
**与****Option-****A的区别：**￼1.ASBR之间建立VPNv4邻居  
2.ASBR之间的接口不再绑定实例，  
通过在接口上使能mpls，  
...
控制平面：￼区别：在ASBR2将192.168.2.0/24的路由通告给ASBR2时  
继续沿用PE2给192.168.2.0/24的私网标签  
即：单向路径上：私网标签一直存在，且不会改变
 
转发（数据）平面：￼区别：只是在ASBR之间是通过MPLS标签交换路由