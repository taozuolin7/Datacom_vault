...
![Exported image](Exported%20image%2020251206151834-0.png)  
...
**令牌桶token bucket：**  
他是一种用于限速控制的底层机制，他用于限制网络中流量的突发成都，确保流量可以按照可控的速度通过网络。  
...
![Exported image](Exported%20image%2020251206151837-1.png)  

**单速双桶**：

![Exported image](Exported%20image%2020251206151839-2.png)  

**双速双桶**：两个桶各补各的令牌，允许长期的突发流量存在，这种突发的流量直接从P桶中拿走令牌就可以了。  
（可能100M的网的体验感一直是150M网的标准）

![Exported image](Exported%20image%2020251206151844-3.png)   
**流量监管：**  
又叫削峰不填谷。超出部分的流量直接砍了，也不会在流量不多的时候把砍掉的部分拿出来重新发送。

![Exported image](Exported%20image%2020251206151846-4.png)

![Exported image](Exported%20image%2020251206151848-5.png)