...
![](assets/IPSec-VPN/file-20251207152010800.png)



**==IPSec-VPN，暂时只能做在路由器出接口上：==**
![500](assets/IPSec-VPN/file-20251207152212653.png)
IPsec配置思路：  
```
1.配置ipsec感兴趣流
acl number 3000
...
```
![](assets/IPSec-VPN/file-20251207152444029.png)
