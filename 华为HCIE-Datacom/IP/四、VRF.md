...
7.在模拟器上只能通过物理接口来访问，而不能通过环回口9+来访问
```

![Exported image](Exported%20image%2020251206164851-0.png)
...
[AR2-GigabitEthernet0/0/1]ip ad 10.1.23.2 24 ￼￼[AR2]ip route-static vpn-instance A 3.3.3.3 32 vpn-instance B 10.1.23.3 ￼[AR2]ip route-static vpn-instance B 1.1.1.1 32 vpn-instance A 10.1.12.1 ￼  
[AR2]ip route-static vpn-instance A 10.1.23.0 255.255.255.0 vpn-instance B 10.1.23.3  
[AR2]ip route-static vpn-instance B 10.1.12.0 255.255.255.0 vpn-instance A 10.1.12.1￼￼[AR1] ip route-static 0.0.0.0 0 10.0.12.2￼[AR2] ip route-static 0.0.0.0 0 10.0.23.2
```
...
![Exported image](Exported%20image%2020251206164852-1.png)

```
￼抓包测试：表明与普通的路由没两样！
```

![Exported image](Exported%20image%2020251206164857-2.png)