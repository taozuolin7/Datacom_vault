...
![](assets/3.MPLS%20TE隧道的实现原理/file-20260203110815653.png)
...
## 基于RSVP-TE的CR-LSP实验：
![](assets/3.MPLS%20TE隧道的实现原理/file-20260204102126855.png)
**实验概述：**
1.底层为 ISIS level-2
2.blue 路径为非链路管理组中
...
**配置严格显示路径**
![](assets/3.MPLS%20TE隧道的实现原理/file-20260204102156254.png)
1.路径必须经过AR3，并且AR7的GE0/0/1 为50MB
